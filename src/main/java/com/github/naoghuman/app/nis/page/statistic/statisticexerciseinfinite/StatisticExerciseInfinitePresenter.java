 ...
 * @author Naoghuman
 */
public class StatisticExerciseInfinitePresenter implements 
        ConfigurationPage, Initializable, Page
{
    ...
    public void initialize(URL location, ResourceBundle resources) {
        LoggerFacade.getDefault().info(this.getClass(), "StatisticExerciseInfinitePresenter.initialize(URL, ResourceBundle)"); // NOI18N
    
        this.initializeMenu();
    }
    
    private void initializeMenu() {
        LoggerFacade.getDefault().info(this.getClass(), "StatisticExerciseInfinitePresenter.initializeMenu()"); // NOI18N
    ...
    public String getKey() {
        return PAGE__STATISTIC_EXERCISE_INFINITE;
    }
